  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500">Pick up new deliveries and start earning</p>
      </div>
          ...
          {jobs.length > 0 ? (
                ...
                <div className="flex flex-col h-full">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-[10px] text-slate-500 uppercase font-bold tracking-widest">Estimated Fee</p>
                    </div>
                  </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-sm font-semibold truncate max-w-[200px]">{job.vendor?.shopName || 'Restaurant'}</p>
                        </div>
                        <div>
                          <p className="text-[10px] text-slate-500 uppercase font-bold">Dropoff</p>
                          <p className="text-sm font-semibold truncate max-w-[200px]">{job.deliveryAddress}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 mt-auto">
                    <Button variant="secondary" className="flex-1" icon={Navigation}>Preview</Button>
            ...
            <div className="lg:col-span-2">
              <GlassCard className="py-20 text-center">
                ...
                <p className="text-slate-500">There are no new orders in your area right now. Check back soon!</p>
              </GlassCard>
            </div>
          )}
        </div>
